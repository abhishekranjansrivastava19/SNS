      ...
      >
        <div className="carousel-inner">
          ...
          <span className="caption">
            <h2 className="heading">To Be The Pioneer Of Academic Excellence And Overall Well-Being</h2>
            <h3>Empowering Students with Behavioral And Technical Knowledge to Become Thought Leaders Of Tommorrow</h3>
          </span>
